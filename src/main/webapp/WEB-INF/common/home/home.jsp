...
<div class="wrap_home">
    ...
    <main id="swContent">
		...
		<article id="mArticle">
			...
			<div class="area_home_profile">
				<div class="wrap_home_profile">
					<div class="inner_home_profile">
						<div class="cell_home_profile">
							<div role="text">
							    <c:choose>
                                    <c:when test="${sessionScope.sMemberId ne null}">
                                        <strong class="tit_home_profile">
                                            <span>반갑습니다, ${sessionScope.sName}님!</span>
                                        </strong>
                                    </c:when>
                                    <c:otherwise>
								        <strong class="tit_home_profile">
									        <span>안녕하세요 SW 선물하기 입니다!</span>
								        </strong>
                                    </c:otherwise>
                                </c:choose>
							</div>
			...
			<div class="area_g area_home_theme">
				...
				<div class="wrap_home_theme">
					<div class="inner_home_theme">
						<ul class="list_home_theme">
						    <c:forEach var="pl" items="${productList}">
							<li class="pList">
                                <a href="/product/detail?pNo=${pl.pNo}">
                                    <div class="info_product">
                                        <span class="wrap_img">
                                            <img class="pdp" src="/img/${pl.pPicture}"/>
                                        </span>
                                        <span class="product_detail">
                                            <span class="screen_out">상품명</span>
                                            <strong class="tit_product" id="product_2250496">${pl.pName}</strong>
                                            <span class="screen_out">현재 가격</span>
                                            <br>
                                            <span class="txt_price">${pl.pPrice}<span class="txt_won">원</span></span>
                                        </span>
                                    </div>
                                </a>
							</li>
